...
// File written on: 2022-02-18 14:46:24.555734
...
label define vl_DOLPROVIDER 0 "Not matched to the DOL list" 1 "Matched to the DOL list" 
label values dolprovider vl_DOLPROVIDER

label define vl_ADMCON7 1 "Required" 2 "Recommended" 3 "Neither required nor recommended" 4 "Do not know" 5 "Considered but not required" 
label values admcon7 vl_ADMCON7
