...
// TODO: colscore_build_stata_meta.py finds two varaibles that are not in the data
//       files. Short-term solution is to place stata capture at the front of each
//       label define and label values statement in colscore_val_lab_writes.do. Need
//       to find a more reliable method of limiting the code generated by 
//       colscore_build_stata_meta.py.
do https://raw.githubusercontent.com/adamrossnelson/colscore/master/colscore_var_lab_writes.do

// TODO: colscore_build_stata_meta.py finds 2989 variables. However the data files
//       contain only 1986 variables. Short-term solution is to place stata capture
//       at the front of each lab var statement in colscore_val_lab_writes.do. Need
//       to find a more reliable method of limiting the code generated by 
//       colscore_build_stata_meta.py.
